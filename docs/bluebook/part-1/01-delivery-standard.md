...
可以先看[品胜电子：竞品调研与产品物料制作](/cases/submissions/pisen-competitive-research-product-materials)，观察资料整理和可交付物如何分开描述；其中的客户陈述仍应按本页的来源和人工确认要求复核，不能直接当作你的效果承诺。
...
继续读本页的[方法或模型](#方法或模型)、[案例与证据](#案例与证据)和[边界与下一步](#边界与下一步)，再对照[来源目录](/bluebook/appendices/sources#r3)理解交付判据、产品事实与社区方法的边界。
...
[下一章：任务拆解与验收](/bluebook/part-1/02-task-delivery-protocol)
